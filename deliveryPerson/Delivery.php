            ...
            <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="index.php">Pooled</a></h1>
							</div>
					  ...
					  <h2>Delivery Information</h2>
						...
						<tbody>
						  <tr>
							...
							<td><input name="" type="text"  maxlength="120" style="margin:10px 20px 0 0;" /></td>
							<td><input name="" type="text"  maxlength="120" style="margin:10px 20px 0 0;" /></td>
							  <td><div class="Button1"><button class="Delivering">NotDelivered</button></div><div class="Button2"><a href = "ReturnPage.php" ><button class="Return">NotReturned</button></a></div></td>
						  </tr>
						</tbody>
					  </table>
					</div>
