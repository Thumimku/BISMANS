						...
						<div class="tab-pane active" id="horizontal-form_1">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<label  class="col-sm-3 control-label" id="ordermodal_orderid"><input name="" type="text"  maxlength="120" style="margin:10px 20px 0 0;" /></label>
									<label  class="col-sm-3 control-label"><strong>Shop Name :</strong></label>
									<label  class="col-sm-3 control-label " id="ordermodal_shopname"><input name="" type="int"  maxlength="120" style="margin:10px 20px 0 0;" /></label>
								</div>
								<div class="form-group">

									<label  class="col-sm-3 control-label"><strong>Shop Address :</strong></label>
									<label  class="col-sm-3 control-label" id="ordermodal_shopaddress"><input name="" type="text"  maxlength="120" style="margin:10px 20px 0 0;" /></label>
									<label  class="col-sm-3 control-label"><strong>City and Province :</strong></label>
									<label  class="col-sm-3 control-label" id="ordermodal_cityandprovince"><input name="" type="text"  maxlength="120" style="margin:10px 20px 0 0;" /></label>
								</div>
								<div class="form-group">
									<label  class="col-sm-3 control-label"><strong>Contact Person :</strong></label>
									<label  class="col-sm-3 control-label" id="ordermodal_contactperson"><input name="" type="text"  maxlength="120" style="margin:10px 20px 0 0;" /></label>
									<label  class="col-sm-3 control-label"><strong>Contact Number :</strong></label>
									<label  class="col-sm-3 control-label" id="ordermodal_contactnumber"><input name="" type="text"  maxlength="120" style="margin:10px 20px 0 0;" /></label>
								</div>
							</form>
						</div>
			 </div>
