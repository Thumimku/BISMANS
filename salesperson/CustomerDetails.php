...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Customer Details</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Customer Details</h2>
								...
								<?php
				include('config.php');
				$query = "SELECT id,CustomerName,ContactPerson,Address,MobileNo,PhoneNo FROM customer";
				...
				$row['ContactPerson'] . '</td><td align="left">'.
				$row['Address'] . '</td><td align="left">' .
				$row['MobileNo'] . '</td><td align="left">' .
				$row['PhoneNo'] . '</td><td align="left">' .
				"<td><a href='EditCustomer.php?id=".$row['id']."'>View</a></td>".
				"<td><a href='DeleteCustomer.php?id=".$row['id']."'>Delete</a></td>";
				echo '</tr>';
				}
