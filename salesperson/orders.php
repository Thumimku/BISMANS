...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Orders</li>
            </ol>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input  type="submit" name="total" value="Total" style="float:right;color:white;"/></b>
							</div>
						</div>
						</form>
					  <h2>Invoice</h2>
						...
						<tbody>
						  <tr id="rowId">
							<td><input name="" type="text" size="17%"  maxlength="60" style="margin:10px 20px 0 0;" /></td>
							<td><input name="" type="text"  maxlength="60" style="margin:10px 20px 0 0;" /></td>
							<td><input name="" type="text"  maxlength="60" style="margin:10px 20px 0 0;" readonly /></td>
							<td><input name="" type="text"  maxlength="60" style="margin:10px 20px 0 0;" readonly /></td>
...
rowCount ++;
var recRow = '<p id="rowCount'+rowCount+'"><tr><td background="#f3faff;"><input name="" type="text" size="17%"  maxlength="60" style="margin:10px 20px 0 0;" /></td><td><input name="" type="text"  maxlength="120" style="margin: 10px 30px 0 25px;" readonly/></td><td><input name="" type="text" maxlength="120" style="margin: 10px 20px 0 0;"/></td><td><input name="" type="text" maxlength="120" style="margin: 10px 20px 0 0;" readonly/></td></tr> <a href="javascript:void(0);" onclick="removeRow('+rowCount+');">Delete</a></p>';
var recRow = '<p id="rowCount'+rowCount+'"><tr><td background="#f3faff;"><input name="" type="text" size="17%"  maxlength="60" style="margin:10px 20px 0 0;" /></td><td><input name="" type="text"  maxlength="120" style="margin: 10px 30px 0 25px;" readonly/></td><td><input name="" type="text" maxlength="120" style="margin: 10px 20px 0 0;"/></td><td><input name="" type="text" maxlength="120" style="margin: 10px 20px 0 0;" readonly/></td></tr> <a href="javascript:void(0);" onclick="removeRow('+rowCount+');">Delete</a></p>';
