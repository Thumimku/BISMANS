						...
						<div class="tab-pane active" id="horizontal-form_1">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<label  class="col-sm-3 control-label" id="deliverymodal_orderid">Order ID</label>
									<label  class="col-sm-3 control-label"><strong>Shop Name :</strong></label>
									<label  class="col-sm-3 control-label" id="deliverymodal_shopname">Shop name</label>
								</div>
								<div class="form-group">

									<label  class="col-sm-3 control-label"><strong>Street Address :</strong></label>
									<label  class="col-sm-3 control-label" id="delievery_streetaddress">Street address</label>
									<label  class="col-sm-3 control-label"><strong>City :</strong></label>
									<label  class="col-sm-3 control-label"id="delievery_city">city</label>
								</div>
								<div class="form-group">
									<label  class="col-sm-3 control-label"><strong>Contact Person :</strong></label>
									<label  class="col-sm-3 control-label"id="delievery_contactperson">contact person</label>
									<label  class="col-sm-3 control-label"><strong>Contact Number :</strong></label>
									<label  class="col-sm-3 control-label" id="delievery_contactnumber">contact number</label>
								</div>
							</form>
						</div>
			 </div>
		   ...
		   <div class="tab-content">
			   <div class="tab-pane active" id="horizontal-form_2">
				   <form class="form-horizontal">
					   ...
					   <div class="form-group">
						   <label  class="col-sm-2 control-label" id="delievery_sku">12586</label>
						   <label  class="col-sm-2 control-label" id="delievery_productname">Paracitamol</label>
						   <label  class="col-sm-2 control-label" id="delievery_quantity">100</label>
						   <label  class="col-sm-2 control-label" id="delievery_unitprice">5</label>
						   <label  class="col-sm-2 control-label" id="delievery_price">calculated</label>
					   </div>
					   <div class="form-group">
			  ...
			  <form class="form-horizontal">
				  <div class="form-group">
					  <div class="form-group">
						  ...
						  <label  class="col-sm-3 control-label" id="delievery_subtotal">sub total</label>

					  </div>
					  <label  class="col-sm-3 control-label" ><strong>Discount :</strong></label>
					  <label  class="col-sm-3 control-label" id="delievery_discount">discount</label>
					  <label  class="col-sm-3 control-label"><strong>Total :-</strong></label>
					  <label  class="col-sm-3 control-label" id="delievery_total">total</label>
				  </div>
      ...
      <div class="panel-footer">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<button class="btn-primary btn" id="delievery_accept">Accept</button>
