						...
						<div class="widget widget-report-table">
							...
							<div class="row m-0 md-bg-grey-100 p-l-20 p-r-20">
								<div class="col-md-6 col-sm-6 col-xs-6 w3layouts-aug">
									<h3>August 2016</h3><!--date-->
									<p>MONTHLY REPORT</p>
								</div>
								<div class="col-md-6 col-sm-6 col-xs-6 ">
									<h2 class="text-right c-teal f-300 m-t-20">Rs.21,235</h2><!--Amount-->
								</div>
							</div>
								...
								<a class="list-group-item media" href="">
									...
									<div class="media-body">
										<div class="pull-left">
											...
											<small class="lg-item-text">0771851234</small>
										</div>
										<div class="pull-right">
								...
								<div class="streamline">
									<div class="sl-item sl-primary">
										<div class="sl-content">
											<small class="text-muted">5 mins ago</small><!--TIME-->
											<p>Approved order.</p>
											<p>Ordered by Salesperson.</p>
										</div>
									</div>
				...
				<div class="col-md-8 agile-info-stat">
					<div class="stats-info stats-last widget-shadow">
						<table class="table stats-table ">
							<h3 align="center">Prroduct with Least stock</h3>
							<thead>
							<tr>
								<th>Product ID</th>
								<th>Product</th>
