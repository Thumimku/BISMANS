...
<div class="left-content">
	   <div class="mother-grid-inner">
		   ...
		   <!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Inventory Details</li>
            </ol>
			...
			<table id="datatable">
				...
				<tr id="inventarydetails_rowid">
					...
					<td id="inventarydetails_sku">
                        <?php echo $inventoryObj->sku; ?>
                    </td>

					<td id="inventarydetails_quantity">
                        <?php echo $inventoryObj->quantity; ?>
                    </td>
