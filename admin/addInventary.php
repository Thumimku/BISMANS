...
<div class="left-content">
	   <div class="mother-grid-inner">
		   ...
		   <!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Add Inventary</li>
            </ol>
<div class="agile-grids">	
			...
			<table id="datatable">
				...
				<tr id="rowId">
                    ...
                    <td id="inventary_expirydate">
                        <input   name="trPrice" type="date" size="10%"/>
                    </td>
    ...
    <script type="text/javascript">
        ...
        function addMoreRows(frm) {
            rowCount ++;
            var recRow = '<tr id="rowCount'+rowCount+'"><td ><input name="trPrice" type="text" size="10%"  maxlength="60" style="margin:10px 38px 0 0;" /></td><td id="inventary_inventaryname"> <select name="trPrice" type="text" style="margin:10px 45px 0 0;"> <option value="">Select...</option> <option value="M">Male</option> <option value="F">Female</option> </select> </td><td id="inventary_sku"><input  name="trPrice" type="text" size="10%"  maxlength="60" style="margin:10px 27px 0 0;"/> </td><td id="inventary_batchnumber"> <input  name="trPrice" type="number" size="10%"  maxlength="60" style="margin:10px 20px 0 0;"/> </td> <td id="inventary_quantity"> <input  name="trPrice" type="number" size="10%"  maxlength="60" style="margin:10px 20px 0 0;"/> </td> <td id="inventary_expirydate"> <input   name="trPrice" type="date" size="10%"  maxlength="60" style="margin:10px 20px 0 0;"/> </td> <td><a href="javascript:void(0);" onclick="removeRow('+rowCount+');">Delete</a></td></tr>';
            jQuery('#addedRows').append(recRow);
        }

        function removeRow(removeNum) {
            $('table#datatable tr#rowCount'+removeNum).remove();
