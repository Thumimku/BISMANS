...
<div class="page-container">
    ...
    <div class="left-content">
        <div class="mother-grid-inner">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Approve Order Details</li>
            </ol>
                        ...
                        <table id="table">
                            ...
                            while ($orderObj = $orderQuery->fetch_object()) {
                                ...
                                if (!isset($_GET['redirect'])){
                                    $link = "approveOrderInvoice.php?orderId=".$orderObj->orderId."&customerId=".$customerId;
                                }else{
                                    $link = '#';
                                }
