        ...
        <?php } ?>
		   ...
		   <div class="grid-form1">
               ...
               <?php if (isset($_GET['employeeId'])){
                   ...
                   $employeeQuery = "SELECT * from tbllogin WHERE userId = $employeeId";
                   $employeeQuery = $mysqli->query($employeeQuery);
                   if ($employeeObj = $employeeQuery->fetch_object()){
				   ...
				   <div class="tab-pane active" id="horizontal-form_1">
					   <form class="form-horizontal" >
                           ...
                           <div class="form-group">
                               ...
                               <label id="editcustomer_customerid" class="col-sm-3 control-label"  ><?php echo $employeeId; ?> </strong></label>
                           ...
                           <div class="form-group">
                               ...
                               <div >
                                   <label><?php echo $lastName;?></label>                               </div>
                           ...
                           <div class="form-group">
                               ...
                               <div >
                                   <label><?php echo $email;?></label>                               </div>
                           ...
                           <div class="form-group">
                               ...
                               <div >
                                   <label><?php echo $strPosition;?></label>                               </div>
						   ...
						   <div class="form-group">
							   ...
							   <div >
                                   <label><?php echo $contactNo;?></label>							   </div>
						   </div>
                           <div class="grid-form1">
                               ...
                               <div class="bs-example" data-example-id="form-validation-states-with-icons">
                                   <form method = "post" action = "employeeAccept.php">
                                       ...
                                       <div class="panel-footer">
                                           <div class="row">
                                               <div class="col-sm-8 col-sm-offset-2">
                                                   ...
                                                   <button class="btn-primary btn" id="addnewcustomer_accept" onclick = "setValue()"> Reject </button>
