...
<div class="left-content">
	   <div class="mother-grid-inner">
		   ...
		   <!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Edit New Customer</li>
</ol>
				   ...
				   <div class="tab-pane active" id="horizontal-form_1">
					   <form class="form-horizontal">
						   ...
						   <div class="form-group">
							   ...
							   <div >
								   <input type="text" class="form-control1" id="editcustomer_streetaddress_1" placeholder="Street Address ">
							   </div><div >
							   <input type="text" class="form-control1" id="editcustomer_streetaddress_2" placeholder="Street Address">
						   </div>
