                ...
                <div class="bs-example" data-example-id="form-validation-states-with-icons">
                    ...
                    <div class="col-md-12 form-group2 group-mail">
                        ...
                        <select name = "assignedTo" required>
                            ...
                            <?php
                            $deliveryPersonQuery = "SELECT userId,firstName from tbllogin WHERE position = 3";
                            $deliveryPersonQuery = $mysqli->query($deliveryPersonQuery);
                            while($deliveryPersonObj = $deliveryPersonQuery->fetch_object()){

                    ?>
                            <option value="<?php echo $deliveryPersonObj->userId; ?>"><?php echo $deliveryPersonObj->firstName; ?></option>
                            <?php }?>
                        </select>
                    </div>
